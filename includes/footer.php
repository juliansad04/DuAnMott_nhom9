...
<footer>
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-col-content">
                        <ul class="icon_list">
                            ...
                            <div class="clear"></div>
                            <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  thanhcodephpngu@gmail.com</a></li>
        ...
        <div class="bg_in">
            <div class="footer">
                <div class="infor_company">
                    <h3>CÔNG TY MIF GOIS</h3>
                    <a href=""><img src="image/da-dang-ky-voi-bo-cong-thuong.png"  alt="da-dang-ky-voi-bo-cong-thuong.png" class="cangiua" /></a>
                    <p class="note_mst">GPĐKKD số: 7777777. Cấp lần 1: 10/10/2015. Thay đổi: 10/10/2023. Nơi cấp: Phòng đăng ký kinh doanh Sở kế hoạch đầu tư TP Cần Thơ</p>
                </div>
    ...
    <div class="clear"></div>
    <div class="copyright">
        <h4 class="tkw9999">&copy; NHOM 9 <a href="http://webextrasite.com/" rel="dofollow" target="_blank">Thiet Ke Web</a> Bởi <a href="#">NGUOI LA</a></h4>
    </div>
</footer>
